...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/24 15:06:50 by grinella          #+#    #+#             */
/*   Updated: 2024/05/24 15:06:51 by grinella         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	raycast(t_game *game, int *x)
{
	...
	game->ray.dir.x = game->player.dir.x + game->player.cam_plane.x
		* game->ray.camera_x;
	game->ray.dir.y = game->player.dir.y + game->player.cam_plane.y
		* game->ray.camera_x;
